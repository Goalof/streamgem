		...
		>
			...
			<Stack margin="0px 0px 0px 0px" padding="0px 15px 0px 15px" min-height="80px">
				...
				<StackItem width="33.3333%" display="flex">
					...
					{"        "}
					<Link href="#" font="750 22px/29px 'Avenir Next Cyr Thin'" color="#F0F0F5" text-decoration-line="initial">
						stream{" "}
						<Span color="#592CF0">
							gem
						</Span>
				...
				<StackItem width="33.3333%" display="flex">
					...
					<Link
						href="#"
						font="450 16px/140% 'Avenir Next Cyr Thin'"
				...
				<StackItem width="33.3333%" display="flex">
					...
					<Link
						href="#"
						font="450 16px/22.4px 'Avenir Next Cyr Thin'"
						color="#F0F0F5"
						text-decoration-line="initial"
		...
		<Section background="#050211">
			...
			<Stack margin="0px 0px 0px 0px" gap="--cmp-stack-gap-small">
				...
				<StackItem width="100%" display="flex">
					...
					<Text color="#ffffff" opacity="0.9" font="750 72px/67.68px 'Avenir Next Cyr Thin'" margin="0px 0px 0px 0px">
				...
				<StackItem width="100%" display="flex">
					<Override slot="StackItemContent" align-items="center" justify-content="center" text-align="center" />
					<Text color="#6C6B7D" opacity="0.9" font="400 22px/30.8px 'Avenir Next Cyr Thin'" margin="0px 0px 0px 0px">
